...
class Order(models.Model):
    ...
    delivery_home = models.CharField(max_length=900, default='False', blank=True, null=True)
    delivery_temple = models.CharField(max_length=900, default='False', blank=True, null=True)
